...
#define  VGA_COL_LIGHTBLUE      0x03
#define  VGA_COL_LIGHTGREEN     0x1D
#define  VGA_COL_LIGHTRED       0xE1
#define  VGA_COL_LIGHTCYAN      0x1E
#define  VGA_COL_LIGHTMAGENTA   0xD2

#define  VGA_COL_BROWN          0x46
